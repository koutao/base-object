package com.koutao.baseobject.modules.swaggerbootstrapui.web;

import com.google.common.base.Optional;
import com.google.common.base.Strings;
import com.google.common.collect.Lists;
import com.koutao.baseobject.modules.swaggerbootstrapui.model.RestHandlerMapping;
import com.koutao.baseobject.modules.swaggerbootstrapui.models.SwaggerBootstrapUi;
import com.koutao.baseobject.modules.swaggerbootstrapui.models.SwaggerBootstrapUiPath;
import com.koutao.baseobject.modules.swaggerbootstrapui.models.SwaggerBootstrapUiTag;
import com.koutao.baseobject.modules.swaggerbootstrapui.models.SwaggerExt;
...
public class SwaggerBootstrapUiController {
    ...
    private void initGlobalHandlerMappings(SwaggerExt swaggerExt, WebApplicationContext wc) {
        if (globalHandlerMappings.size() == 0) {
            ...
            String parentPath = "";
            //判断basePath
            if (!StringUtils.isEmpty(swaggerExt.getBasePath()) && !SLASH.equals(swaggerExt.getBasePath())) {
