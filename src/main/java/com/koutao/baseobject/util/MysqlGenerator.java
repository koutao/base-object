...
public class MysqlGenerator {
    ...
    private static String table="test";                  //table名字
    private static String prefix="sc_";                     //table前缀
    private static String path = new File(packageName).getAbsolutePath();
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new StrategyConfig()
                        ...
                        // 自定义 controller 父类
                        .setSuperControllerClass(packagePrefix + packageName+".controller.AbstractController")
